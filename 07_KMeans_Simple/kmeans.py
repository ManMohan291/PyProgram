...
def plotKmean(X,idx):
    # plt.subplot(122)
    plt.scatter(X[:,0],X[:,1],marker=".",facecolors='black', edgecolors='none') 
    plt.scatter(X[np.where(idx==0),0],X[np.where(idx==0),1],marker="o",facecolors='none', edgecolors='r')
    plt.scatter(X[np.where(idx==1),0],X[np.where(idx==1),1],marker="o",facecolors='none', edgecolors='b')
    plt.scatter(X[np.where(idx==2),0],X[np.where(idx==2),1],marker="o",facecolors='none', edgecolors='g')
